<div class="w-full">
    ...
    <section class="pb-24 pt-10">
        <div class="px-2 lg:px-5">
            <div class="flex gap-2 flex-wrap justify-between w-full items-end text-gray-500">
                <div class="w-full max-w-xl pb-2">
                    <p class="mb-1 text-green-500">Welcome to</p>
                    <h2 class="mb-1 text-3xl uppercase font-extrabold text-black tracking-wide">medan, north Sumatra <span class="text-red-600">indonesia</span></h2>
                    <p class="m-0 text-justify">Medan is not just a destination, but a journey of
                    ...
                    <div class="tab-content border-base-300 p-5">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div class="border-base-300 shadow rounded-xl flex flex-col items-center px-2 py-1 bg-white">
                                ...
                                <div class="py-5 px-2">
                                    <h4 class="uppercase text-xl mb-2 font-semibold text-gray-700">Medan to Lake Toba</h4>
                            ...
                            <div class="border-base-300 shadow rounded-xl flex flex-col items-center px-2 py-1 bg-white">
                                ...
                                <div class="py-5 px-2">
                                    <h4 class="uppercase text-xl mb-2 font-semibold text-gray-700">Medan to Berastagi</h4>
